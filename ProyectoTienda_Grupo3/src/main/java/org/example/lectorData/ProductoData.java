...
public class ProductoData {
    private static ProductoData productoDataInstance;
    private static final String FILE_PATH = "archivos/productos.csv";
    private static Path path = Paths.get(FILE_PATH);


    /*
    public static ProductoData getInstance(){
        if(productoDataInstance == null){
            productoDataInstance = new ProductoData();
        }
        return productoDataInstance;
    }
